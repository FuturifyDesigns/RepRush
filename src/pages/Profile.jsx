        ...
        <div className="relative z-10 container mx-auto px-4 mt-12">
          <div className="flex items-end gap-6">
            ...
            <div className="relative">
              ...
              {/* Level Badge - Moved lower to not block avatar */}
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 px-4 py-1.5 bg-gradient-to-r from-orange-500 to-red-600 rounded-full border-4 border-gray-900 shadow-lg">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            {/* Account Settings - First for visibility */}
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-4">Account Settings</h3>
              <div className="space-y-3">
                <button
                  onClick={() => setShowEditModal(true)}
                  className="w-full px-4 py-3 bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/50 text-orange-400 rounded-lg font-medium transition-all text-sm flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full px-4 py-3 bg-red-500/10 hover:bg-red-500/20 border border-red-500/50 text-red-400 rounded-lg font-medium transition-all text-sm flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
